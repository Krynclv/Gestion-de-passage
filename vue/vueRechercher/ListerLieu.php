<?php
 ...
 {
    $lieu = $ligne['LibelleLieu'];
 }
?>
    <h1 style='text-align:center;'> Historique du lieu : </h1><br>
    <h2 style='text-align:center; margin-bottom:3%;'><?php echo $lieu ?></h2>
